...
car_image = imread(filename, as_gray=True) #reads the image "car.jpg" in a grayscale mode as a 2D array. Each row and column in the array corresponds to a pixel in the image. Each entry in the array is the intensity or brightness of the pixel. This value for the intensity is between 0 (black) and 1 (white) in skimage.
#it should be a 2 dimensional array
print("Image Dimensions:", car_image.shape)#prints the length and width of the image in pixels
